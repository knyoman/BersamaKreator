  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isConfigured) {
        ...
        console.log('Result Data:', resultData); // Debug log
      
      } else {
        // 2. Not Configured
        throw new Error("AI Backend URL is not configured in .env.local (VITE_EDGE_FUNCTION_AI_URL)");
      }
                        ...
                        <div className="flex flex-col md:flex-row gap-6">
                          ...
                          <div className="flex-1 space-y-4">
                            ...
                            <div>
                              <div className="flex items-start justify-between gap-4 mb-2">
                                <div>
                                  <h4 className="text-2xl font-bold text-gray-900 mb-1">
                                    {inf.users?.name || 'Unknown Influencer'}
                                  </h4>
                              ...
                              {inf.bio && (
                                <p className="text-gray-600 text-sm mt-2">{inf.bio}</p>
                              )}
                            </div>
                            ...
                            <div className="flex flex-wrap items-center justify-between gap-4 pt-4 border-t border-gray-200">
                              <div className="flex items-center gap-3">
                                {inf.instagram_url && (
                                  <a href={inf.instagram_url} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gradient-to-br from-purple-500 to-pink-500 rounded-lg flex items-center justify-center text-white hover:scale-110 transition-transform">
                              ...
                              <div className="flex items-center gap-4">
                                <div className="text-right">
                                  ...
                                  <div className="text-2xl font-bold text-gray-900">
                                    Rp {parseInt(inf.price_per_post).toLocaleString('id-ID')}
                                  </div>
                                </div>
